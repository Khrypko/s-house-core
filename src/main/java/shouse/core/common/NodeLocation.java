...
public enum NodeLocation {
    ...
    public static List<NodeLocationInfo> getLocations(){
        return Arrays.asList(values()).stream().map(location -> new NodeLocationInfo(location.id, location.name)).collect(Collectors.toList());
    }
